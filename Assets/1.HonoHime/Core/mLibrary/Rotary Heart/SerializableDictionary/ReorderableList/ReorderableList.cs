...
namespace RotaryHeart.Lib.SerializableDictionary
{
    ...
    public class ReorderableList
    {
        ...
        {
            if (showDefaultBackground && UnityEngine.Event.current.type == EventType.Repaint)
            {
                Style.headerBackground.Draw(rect, false, false, false, false);
            }

            HandleDragAndDrop(rect, UnityEngine.Event.current);
        ...
        private void UpdateElementRects(Rect rect, UnityEngine.Event evt)
        {
        ...
        private void DrawElements(Rect rect, UnityEngine.Event evt)
        {
        ...
        private void HandleDragAndDrop(Rect rect, UnityEngine.Event evt)
        {
        ...
        private void HandlePreSelection(Rect rect, UnityEngine.Event evt)
        {
        ...
        private void HandlePostSelection(Rect rect, UnityEngine.Event evt)
        {
        ...
        private bool IsSelectionButton(UnityEngine.Event evt)
        {
            return evt.button == 0 || evt.button == 2;
        }

        private void DoSelection(int index, bool setKeyboardControl, UnityEngine.Event evt)
        {
        ...
        class ListSelection : IEnumerable<int>
        {
            ...
            public void SelectWhenNoAction(int index, UnityEngine.Event evt)
            {
            ...
            public void AppendWithAction(int index, UnityEngine.Event evt)
            {
