...
namespace Opsive.Shared.Integrations.InputSystem
{
    ...
    public class UnityInputSystem : Opsive.Shared.Input.PlayerInput
    {
...
#endif
        [Tooltip("Enable Disable PlayerInput when the Unity Input System is enabled/disabled.")]
        [SerializeField] protected bool m_SyncEnablePlayerInput;
...
#endif
        public bool SyncEnablePlayerInput { get => m_SyncEnablePlayerInput; set => m_SyncEnablePlayerInput = value; }
        ...
        protected override void Awake()
        {
            ...
            m_PlayerInput = GameObject.FindObjectOfType<UnityEngine.InputSystem.PlayerInput>();
        }
