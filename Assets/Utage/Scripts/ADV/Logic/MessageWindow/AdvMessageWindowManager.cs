...
namespace Utage
{
	...
	public class AdvMessageWindowManager : MonoBehaviour, IAdvSaveData
	{
		...
		public void SelectionRevealPrePage()
        {
            if (prePage == null)
            {
				Debug.LogError("Don't have pre page.");
				return;
            }
			CurrentWindow.PageTextRevealUnconditional(prePage);
			OnTextChange.Invoke(this);
		}
