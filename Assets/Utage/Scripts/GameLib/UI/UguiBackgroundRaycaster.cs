...
namespace Utage
{
	...
	public class UguiBackgroundRaycaster : BaseRaycaster
	{
		...
		[SerializeField] Vector2 detectRange_x;
		[SerializeField] Vector2 detectRange_y;
		...
		public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
		{
			...
			if (pos.x < detectRange_x.x || pos.x > detectRange_x.y || pos.y < detectRange_y.x || pos.y > detectRange_y.y)
				return;
